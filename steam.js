...
const AttackManager = function AttackManager() {// Script by vk.com/0bugs
...
const GetBestZone = function GetBestZone() {
    ...
    if(bestZoneIdx !== undefined) {
        console.log(`zone ${bestZoneIdx} progress: ${GAME.m_State.m_Grid.m_Tiles[bestZoneIdx].Info.progress} difficulty: ${highestDifficulty}`);// Script by vk.com/0bugs
    }
...
pixi.ticker.add(context.BOT_FUNCTION); // Script by vk.com/0bugs
